...
#### * 注意：每台设备每月可以使用10GB流量(目前服务器压力和成本投入有限，待情况有所改善后会提升至15G/月)，超过10GB将停止本月该设备的使用，只能等待下月重置流量后方可使用。对于大部分人来说，一个月10G流量是足够翻墙需求的。若您使用量比较大，每个月10G流量都不够用，作者建议您再配合其他V.P.N一起使用。
