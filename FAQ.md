...
#### 目前已知比较重大的bug:设备id识别不能唯一，会出现同款手机同一机型在同一安卓系统版本被本软件识别成了同一个设备id。这些一样的设备id将无法独享10G流量，而是共享了10G流量，这就是为什么有些用户明明没怎么用却产生了很多流量。最近几天我将推出下一个版本并使用新的设备唯一识别算法来解决这个问题，给大家带来的不便，尽请谅解！

#### *警告！有一台服务器因为有人用bt下载国外受版权的资源而被封停了，再次提醒各位，禁止使用本软件行进BT&磁力/迅雷协议等p2p下载。
